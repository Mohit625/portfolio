  ...
  return (
    <section id="blog" className="py-20">
      ...
      <motion.div
        ...
        >$ fetch blog</motion.div>
        <motion.h2 initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.1 }}
          viewport={{ once: true }}
          className="text-4xl lg:text-5xl font-bold mb-16">Latest Articles</motion.h2>
          ...
          >
            <Card
              ...
              <CardHeader>
                ...
                <a href={post.url}>
                  {post.title}
                <p className="text-sm text-muted-foreground mb-1">{post.readable_publish_date}</p>
                </a>
                </CardTitle>
